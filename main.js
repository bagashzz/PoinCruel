...
const phoneNumber = await question(color('Masukin No Awal 628 Jangan Masukin Nama poin Ganteng🗿🗿 Ga Bisa Bang🗿:\n', 'red'));
...
Skyzo.sendMessage("6289526640145@s.whatsapp.net", {text: "*BOT OPEN BANG POIN😜*"})
